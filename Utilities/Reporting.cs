// <copyright file="Reporting.cs" company="Metlife">
...
namespace INF.CodedUI.TestAutomation.Utilities
{
    ...
    public class Reporting
    {
        ...
        /// </summary>
        /// <value>Number of Test cases.</value>
        public static int Iteration { get; set; }

        /// <summary>
        /// Gets or sets Test case file path.
        /// </summary>
        /// <value>File path.</value>
        public static string FilePath { get; set; }

        /// <summary>
        /// Gets or sets File Path string.
        /// </summary>
                ...
                using (var excelConnection = new OleDbConnection(con))
                {
                    using (var command = new OleDbCommand())
                    {
                        ...
                        command.Parameters.AddWithValue(
                            Entities.Constants.TestResultSummary.DescriptionSummaryParam,
                            TestCase.Description);

                        command.Parameters.AddWithValue(
                            Entities.Constants.TestResultSummary.ResultSummaryParam,
                            Result.GetTestScriptResult());

                        command.Parameters.AddWithValue(
                            Entities.Constants.TestResultSummary.ExecutionDurationParam,
                            Timing.TestCaseduration);

                        if (string.IsNullOrEmpty(TestCases.Hyplink) || TestCases.Hyplink == null)
                        {
                            command.Parameters.AddWithValue(
                                Entities.Constants.TestResultSummary.ExecutionDocumentReference,
                                Entities.Constants.Na);
                        }
                        else
                        {
                            command.Parameters.AddWithValue(
            ...
            try
            {
                ...
                switch (reportingStyle)
                {
                    case ReportingStyles.StyleHeader:
                        styleName = Entities.Constants.StyleNames.StyleHeader;
