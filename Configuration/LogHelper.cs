// <copyright file="LogHelper.cs" company="Metlife">
...
namespace INF.CodedUI.TestAutomation.Configuration
{
    ...
    public class LogHelper
    {
        ...
        /// </summary>
        /// <param name="message">Error Message being returned.</param>
        ...
        public static void EventLog(string message, string className = "", string method = "")
        {
            try
            {
                var logMessage =
                    new StringBuilder().Append(TestCases.TestSessionId)
        ...
        /// </summary>
        /// <param name="ex">Exception Message being returned.</param>
        /// <param name="className">Error Message being returned from class file.</param>
        /// <param name="method">Error Message being returned from class file and its method.</param>
        public static void ErrorLog(Exception ex, string className = "", string method = "")
        {
            try
            {
                var logMessage = new StringBuilder().Append(TestCases.TestSessionId)
                    .Append(Constants.Tab)
                    .Append(DateTime.Now)
                    .Append(Constants.Tab)
        ...
        public static void WriteLog(string message, string logFileName)
        {
            ...
            using (var sw = File.AppendText(rootFilePath.Append(Constants.DoubleBackslash).Append(logFileName).Append(Constants.Txt).ToString()))
            {
